...
export default function Cart() {
  ...
  const handleCheckOut = async () => {
    ...
    let response = await fetch("https://MedCart.vercel.app/api/orderData", {
      method: 'POST',
      headers: {
  ...
  const handleCheckOutOnline = async () => {
    let userEmail = localStorage.getItem("userEmail");
    let response = await fetch("https://medcart-backend.vercel.app/api/orderData", {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  try {
    const response = await fetch("https://MedCart.vercel.app/api/payment", {
      method: "POST",
      headers: headers,
